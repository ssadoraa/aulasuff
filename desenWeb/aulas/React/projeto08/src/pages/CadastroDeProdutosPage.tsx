...
const CadastroDeProdutosPage = () => {
    ...
    if (isError || categorias === undefined) return <div>Ocorreu um erro ao buscar as categorias</div>;
        ...
        <div className="container mt-5">
            ...
            <form>
                ...
                <div className="mb-3">
                    ...
                    <textarea className="form-control" id="descricao" placeholder="Descrição"></textarea>
                </div>
                <div className="mb-3">
                ...
                <div className="mb-3">
                    ...
                    <div className="col-lg-8">
                        <div className="form-check form-check-inline">
                            <input className="form-check-input" type="radio" name="condicao" id="usado" value="usado" />
                            <span className="form-check-label">Usado</span>
                        </div>
                        <div className="form-check form-check-inline">
                            <input className="form-check-input" type="radio" name="condicao" id="novo" value="novo" />
                            <span className="form-check-label">Novo</span>
                        </div>
                        <div className="form-check form-check-inline">
                            <input className="form-check-input" type="radio" name="condicao" id="sem_funcionalidade" value="sem_funcionalidade" />
                            <span className="form-check-label">Sem Funcionalidade</span>
                        </div>
                    </div>
                </div>         
                <div className="mb-3">
                    <label htmlFor="valorEstimado" className="form-label">Valor Estimado:</label>
                    <input type="number" className="form-control" id="valorEstimado" placeholder="Valor Estimado" />
                </div>
                <div className="mb-3">
