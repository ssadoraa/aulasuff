package com.isadoraverbicario.util;
...
public class FabricaDeDAOs {
	public static <T> T getDAO(Class<T> tipo) {
		// Permite que a gente investigue as classes no package "com.isadoraverbicario.dao.impl"
		Reflections reflections = new Reflections("com.isadoraverbicario.dao.impl");

		// Nesse momento a variável tipo estará valendo Produto.class
		// A linha abaixo verifica se no package "com.isadoraverbicario.dao.impl"
